...
def test_auto_postpone_only_executes_once_per_day(repository, time_machine, mocker):
    ...
    #mock_get = mocker.patch("todo_bene.infrastructure.config.get_last_postpone_date", return_value=None)
    # mock_update = mocker.patch("todo_bene.infrastructure.config.update_last_postpone_date")
    # Dans le test, remplacez par :
